...
function MessageInputBar() {
  ...
  return (
    <div className="px-4 pb-4 pt-2">
      <form className="bg-lightSlate dark:bg-lightSlate-dark dark:border-borderShade-dark border-borderShade mx-auto grid  max-w-3xl grid-cols-[1fr_auto] overflow-hidden rounded-full border">
        <input
        ...
        <button
          className={`m-1 flex h-10 w-10 items-center justify-center rounded-full bg-violet-500 text-2xl hover:bg-violet-600 active:scale-95`}
